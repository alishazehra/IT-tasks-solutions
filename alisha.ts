...
/* question 5 Famous Quote 2: Repeat Exercise 4,
 but this time store the famous person’s name in a variable called famous_person.
  Then compose your message and store it in a new variable called message.
   ...
   let m: string = `${famous_person } once said, "${quote}"`;
   console.log(message);
...
/* question 9 Favorite Number:
 ...
 Print that message.*/
let fav_num = "42";
let msg = "My favourite number is 42";
...
let names : string [] =["ali", "haseeb", "fatima", "maria"]
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3])
...
let guestAr : string[] = ["Ali", "haseeb", "wajahat"]
let canNotAttend : string = "Ali"
//console.log(canNotAttend + " " "can not attend the dinner.")
let NewGuest : string = "Alisha"
...
let guests: string[] = ["Maham", "Bilal" , "Carry", "Dawood"];
...
• Sort to change your array so it’s stored in reverse alphabetical order.
 Print the list to show that its order has changed*/
   ...
   let country: string[] = ["Pakistan", "India" ,"NewYork"];
   ...
   let person: {name: string, fname: string , age: number} = {name: "Mehak", fname: "female", age: 18};
   console.log(person)
...
• Test whether an item is not in a array*/
  let name_1 : string = "Alisha"
  let name_2 : string = "Alisha Zehra"
  let name_3 : string = "miss Alisha Zehra"
 // if (name_1 == name_3)[
