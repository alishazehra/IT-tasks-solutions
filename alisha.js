...
var m = "".concat(famous_person, " once said, \"").concat(quote, "\"");
console.log(message);
/*
...
/* question 9 Favorite Number:
 ...
 Print that message.*/
var fav_num = "42";
var msg = "My favourite number is 42";
...
var friendsName = ["Hamza", "Usman", "Ayesha", "Areeba"];
...
var guestAr = ["Ali", "haseeb", "wajahat"];
...
guestArr.map(function (items) {
    return console.log("Dear ".concat(items, ", you are invited in the more people category list on dinner"));
});
...
var guests = ["Maham", "Bilal", "Carry", "Dawood"];
...
guests.forEach(function (guest) {
    return console.log(" Dear ".concat(guest, ", you are still invited to dinner"));
});
...
var placesToVisit = ["Tokyo", "Pakistan", "Turkey", "Japan"];
...
console.log("".concat(count_invitations, " people welcome to the dinner"));
// Question 20
...
var country = ["Pakistan", "India", "NewYork"];
...
var person = { name: "Mehak", fname: "female", age: 18 };
console.log(person);
...
var name_1 = "Alisha";
var name_2 = "Alisha Zehra";
var name_3 = "miss Alisha Zehra";
// if (name_1 == name_3)[
...
//let favourite_fruits : string[] = ["orange", "apples", "grapes"]
...
var favourite_pizza = ["pepporoni", "chicken", "veg"];
